// MedUHC2 Tab with ColumnManager integration - EXACT replica of MedUHCTabWithColumns
...
const MedUHC2TabWithColumns = forwardRef(({ initialData = null, onDataChange = () => {} }, ref) => {
  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-slate-50">
      ...
      <div className={`mx-auto w-full px-4 py-4 ${columns.length > 4 ? 'overflow-x-auto' : 'max-w-7xl'}`}>
        ...
        {/* Content Area */}
        <div style={columns.length > 4 ? { minWidth: `${200 + (columns.length * 180)}px` } : {}}>
...
MedUHC2TabWithColumns.displayName = 'MedUHC2TabWithColumns';

export default MedUHC2TabWithColumns;